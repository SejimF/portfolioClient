function downloadJSAtOnload() {
    ...
    jquery.src = "../oldPortfolio/scripts/jquery-3.4.1.min.js";
...
function loadJQueryRelatedScripts() {
    ...
    setTimeout(function () {
        ...
        polyfill.src = "../oldPortfolio/scripts/polyfills.js";
        document.body.appendChild(polyfill);

        var restCss = document.createElement("link");
        restCss.rel = "stylesheet";
        restCss.href = "../oldPortfolio/css/restStyles.min.css";
        ...
        jqueryUi.src = "../oldPortfolio/scripts/jquery-ui.min.js";
        jqueryUi.defer = true;
        document.body.appendChild(jqueryUi);
        jqueryUi.onload = function () {

            var jqueryUiTouch = document.createElement("script");
            jqueryUiTouch.src = "../oldPortfolio/scripts/jquery.ui.touch-punch.min.js";
            ...
            jqueryUiTouch.onload = function () {
                ...
                hammer.src = "../oldPortfolio/scripts/hammer.min.js";
...
(function(d, s, id){
   ...
   fjs.parentNode.insertBefore(js, fjs);
    ...
    compressed.src = "../oldPortfolio/scripts/compressed.min.js";
